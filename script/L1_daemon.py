...
class ClientDaemon(CDaemon):
    ...
    def run(self, output_fn, **kwargs):
        job_name_list = ['/home/HZQX/Project/OM/hz/script/main_L1_broadcast_4000.sh',
                         '/home/HZQX/Project/OM/hz/script/main_L1_broadcast_1000.sh',
                         '/home/HZQX/Project/OM/hz/script/main_L1_orginal_2000.sh',
                         '/home/HZQX/Project/OM/hz/script/main_L1_orginal_1000.sh',
                         '/home/HZQX/Project/OM/hz/script/main_L1_orginal_500.sh'] * 3600
        while True:
            pool = Pool(processes=5)
            for job_name in job_name_list:
                time.sleep(5)
                pool.apply_async(run_job_sh, (job_name,))
            pool.close()
            pool.join()
            time.sleep(5)
#         fd = open(output_fn, 'w')
...
def run_job_sh(sh_name):

    #     if not os.path.isfile('./test.log'):
    #         fd = open('./test.log', 'w')
    #     else:
    #         fd = open('./test.log', 'a+')
    #     line = time.ctime() + sh_name + '\n'
    #     fd.write(line)
    #     fd.flush()
    #     fd.close()
