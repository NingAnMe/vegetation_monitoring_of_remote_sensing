...
# 广播4000米 调度
python2.7 L1_main.py -s HIMAWARI_AHI_4000_BROADCAST -j 0210 -t $stime -p $port --thread 14
python2.7 L1_main.py -s HIMAWARI_AHI_4000_BROADCAST -j 0410 -t $stime -p $port --thread 1
python2.7 L1_main.py -s HIMAWARI_AHI_4000_BROADCAST -j 0510 -t $stime -p $port --thread 1
python2.7 L1_main.py -s HIMAWARI_AHI_4000_BROADCAST -j 0610 -t $stime -p $port --thread 14
...
do
    ...
    echo python2.7 Province_push.py HIMAWARI_AHI_4000_BROADCAST $start_time
    python2.7 Province_push.py HIMAWARI_AHI_4000_BROADCAST $start_time
    wait
