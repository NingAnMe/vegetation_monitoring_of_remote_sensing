...
# 原分2000米 调度
python2.7 L1_main.py -s HIMAWARI_AHI_2000_ORIGINAL -j 0110 -t $stime -p $port --thread 8
python2.7 L1_main.py -s HIMAWARI_AHI_2000_ORIGINAL -j 0210 -t $stime -p $port --thread 16
python2.7 L1_main.py -s HIMAWARI_AHI_2000_ORIGINAL -j 0410 -t $stime -p $port --thread 1
python2.7 L1_main.py -s HIMAWARI_AHI_2000_ORIGINAL -j 0510 -t $stime -p $port --thread 1
python2.7 L1_main.py -s HIMAWARI_AHI_2000_ORIGINAL -j 0610 -t $stime -p $port --thread 12
...
do
    ...
    echo python2.7 Province_push.py HIMAWARI_AHI_2000_ORIGINAL $start_time
    python2.7 Province_push.py HIMAWARI_AHI_2000_ORIGINAL $start_time
    wait
